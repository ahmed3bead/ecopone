...
Route::resource('pages', \App\CouponApp\Modules\Pages\Web\Controllers\PageController::class);
Route::resource('occasions', \App\CouponApp\Modules\Occasions\Web\Controllers\OccasionController::class);